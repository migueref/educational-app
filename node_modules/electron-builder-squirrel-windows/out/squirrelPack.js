...
let releasify = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (options, nupkgPath, outputDirectory, packageName) {
        ...
        const out = (yield (0, (_builderUtil || _load_builderUtil()).exec)(process.platform === "win32" ? _path.join(options.vendorPath, "Update.com") : "mono", (0, (_builderUtil || _load_builderUtil()).prepareWindowsExecutableArgs)(args, _path.join(options.vendorPath, "Update-Mono.exe")), {
            maxBuffer: 4 * 1024000
        })).trim();
